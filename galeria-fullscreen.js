...
$(".exit").on("click", function () {
  ...
  $(
    "#body-top > div.galeria-fullscreen.on > div > div > div.imagenfull.on > div.contenedor-imagenfull > div > span"
  ).remove();
  ...
  setTimeout(function () {
    ...
    if (
      $("#galeria-imagen2").hasClass("clicked") ||
      $("#galeria-imagen6").hasClass("clicked") ||
      $("#galeria-imagen10").hasClass("clicked") ||
      $("#galeria-imagen14").hasClass("clicked")
    ) {
      moverI();
    } else if (
      $("#galeria-imagen3").hasClass("clicked") ||
      $("#galeria-imagen7").hasClass("clicked") ||
      $("#galeria-imagen11").hasClass("clicked") ||
      $("#galeria-imagen15").hasClass("clicked")
    ) {
      moverI();
      moverI();
    } else if (
      $("#galeria-imagen4").hasClass("clicked") ||
      $("#galeria-imagen8").hasClass("clicked") ||
      $("#galeria-imagen12").hasClass("clicked") ||
      $("#galeria-imagen16").hasClass("clicked")
    ) {
      moverI();
      moverI();
      moverI();
