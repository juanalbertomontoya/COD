...
//Rectificación
$('#rectificacion > .contenedor').hover(
  function(){ 
...
//Inscripciones
$('#inscripciones > .contenedor').hover(
  function(){ 
...
//Independización
$('#independizacion > .contenedor').hover(
  function(){ 
