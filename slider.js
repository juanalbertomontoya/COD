...
//mover ultima columna al primer lugar//
 ...
 $('#contenido-galeria section:last').insertBefore('#contenido-galeria section:first');
 ...
 function moverD() {
  ...
  slider.animate({marginLeft:'-'+280+'px'
  } ,700, 
  function(){

    $('#contenido-galeria section:first').insertAfter('#contenido-galeria section:last');
    slider.css('margin-left', '-'+140+'px');
